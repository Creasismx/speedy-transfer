...
# SECURITY NOTE: For production, set EMAIL_HOST_PASSWORD in your .env file
# instead of hardcoding it here. The default value is provided for development.
