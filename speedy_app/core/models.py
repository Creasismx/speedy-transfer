...
class Certificate(models.Model):
    ...
    icon_svg = models.TextField(help_text="SVG path element (the 'd' attribute value)", blank=True, null=True)
    image = models.ImageField(upload_to='certificates/', blank=True, null=True, help_text="Upload certificate image (JPG/PNG). If provided, this will be used instead of the SVG icon.")
